...
// https://github.com/Arryboom/ecies/blob/master/ecies.go
// https://github.com/ethereum/go-ethereum/crypto/ecies/ecies.go
...
func Encrypt(rand io.Reader, pub *PublicKey, m, s1, s2 []byte) (ct []byte, err error) {
	...
	K, err := concatKDF(h, z, s1, params.KeyLen+params.KeyLen)
	if err != nil {
		return
	}
	Ke := K[:params.KeyLen]
